...
namespace TSP_Covid21.Models.ShopEntity
{
    ...
    public partial class COVIDEntities : DbContext
    {
        ...
        public virtual DbSet<ww_TEST_Detail> ww_TEST_Detail { get; set; }
        public virtual DbSet<ww_TEST_MySensor> ww_TEST_MySensor { get; set; }
        public virtual DbSet<ww_TEST_Sensor> ww_TEST_Sensor { get; set; }
